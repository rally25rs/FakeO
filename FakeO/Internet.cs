...
namespace FakeO
{
  public static class Internet
  {
    ...
    {
      return System.String.Format("{0}@{1}", UserName(), DomainName());
    }

    public static string Email(string name)
    {
      return System.String.Format("{0}@{1}", UserName(name), DomainName());
    }

    public static string FreeEmail()
    {
      return System.String.Format("{0}@{1}", UserName(), new[] { "gmail.com", "yahoo.com", "hotmail.com" }.Random());
    }
    ...
    {
      return System.String.Format("{0}.{1}", DomainWord(), DomainSuffix());
    }
